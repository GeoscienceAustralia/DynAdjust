...
const char* const RELAXATION = "relaxation";
...
const char* const IGNORE_INSUFFICIENT_MSRS = "ignore-insufficient-msrs";
...
const char* const DAT_FILEPATH_UNC = "dat-uncertainty-file";
