...
#include <cstring>      // for strcpy, snprintf
#include <iostream>     // for stream output operators
#include <iomanip>      // for std::setw, std::setprecision, std::fixed, std::left, std::right
